...
**所有文档必须遵循统一的文档规范标准，详见 [docs/.templates/document-standard.md](./docs/.templates/document-standard.md)**
...
**所有文档必须在顶部包含 YAML 元数据**:

```markdown
---
title: 文档标题
type: 文档类型 (adr/spec/guide/report/technical/api/deployment/workflow)
category: 文档分类目录
status: 文档状态 (draft/review/approved/deprecated/archived)
version: 1.0.0
created: 2026-01-15
updated: 2026-01-15
author: 作者名称
...
**更新文档时**:
1. 修改 `version` 字段（增加 PATCH 或 MINOR）
2. 更新 `updated` 日期
3. 修改内容
4. 提交审查
...
**详细规范**: 📖 **[docs/.templates/document-standard.md](./docs/.templates/document-standard.md)**
